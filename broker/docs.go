...
//
// * OpNoSubscriber (0) - will be broadcasted by broker to all publishers if no
...
// OpSyncSubscribers.
//
// * OpHasSubscribers (1) - will be broadcasted to all publishers everytime when
...
//
// * OpSyncSubscribers (2) - can be sent by publisher to check if there is any
// subscribers left in broker. This message usualy will be sent by publisher on
// startup.
//
// * OpMessage (3) - this is the only message that can be accepted by subscibers.
